...
def laplacianeigenmaps(datafile, graph, ids, traces, y, dimension, graph_aggregation):
    """
    Use the laplacian eigen maps method
    ...
    encoding_name = 'laplacianeigenmaps'
    ...
    # generate model
    model = LaplacianEigenmaps(dimensions=dimension)
    model.fit(graph)
