...
def nmfadmm(datafile, graph, ids, traces, y, dimension, graph_aggregation):
    """
    Use the nmfadmm method
    ...
    # generate model
    model = NMFADMM(dimensions=int(dimension/2))
    model.fit(graph)
