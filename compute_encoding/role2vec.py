...
def role2vec(datafile, graph, ids, traces, y, dimension, graph_aggregation):
    """
    Use the role2vec method
    ...
    # generate model
    model = Role2Vec(dimensions=dimension, workers=n_workers)
    model.fit(graph)
