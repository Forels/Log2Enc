...
def walklets(datafile, graph, ids, traces, y, dimension, graph_aggregation):
    """
    Use the walklets method
    ...
    # generate model
    model = Walklets(dimensions=int(dimension/4), workers=n_workers)
    model.fit(graph)
