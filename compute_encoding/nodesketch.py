...
def nodesketch(datafile, graph, ids, traces, y, dimension, graph_aggregation):
    """
    Use the nodesketch method
    ...
    # generate model
    model = NodeSketch(dimensions=dimension)
    model.fit(graph)
